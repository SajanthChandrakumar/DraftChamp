...
import type { Combo, Formation, Player } from "../api/types";
import { isDraftComplete } from "../game/eligibility";
import type { DraftedPlayer } from "./draftContext";
...
export interface DuelState {
  ...
  filledA: Record<string, DraftedPlayer>;
  filledB: Record<string, DraftedPlayer>;
...
export type DuelAction =
  | { type: "START_DUEL"; formationA: Formation; formationB: Formation }
